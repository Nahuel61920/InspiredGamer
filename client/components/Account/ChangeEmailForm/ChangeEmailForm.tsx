        ...
        <Form onSubmit={formik.handleSubmit}>
            <Form.Group widths='equal'>
                ...
                >
                    ...
                    <input type='text' placeholder='Repeat email' name='repeatEmail' onChange={formik.handleChange} value={formik.values.repeatEmail} />
                    {formik.errors.repeatEmail && <span className='error-msg'>{formik.errors.repeatEmail}</span>}
                </Form.Field>
            </Form.Group>
...
function validationSchema() {
    return {
        ...
        repeatEmail: Yup.string().required("Repeat email is required.").oneOf([Yup.ref("email")], "The emails must be the same.")
    }
}